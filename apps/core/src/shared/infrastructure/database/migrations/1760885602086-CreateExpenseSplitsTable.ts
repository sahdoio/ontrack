...
export class CreateExpenseSplitsTable1760885602086 implements MigrationInterface {
    name = 'CreateExpenseSplitsTable1760885602086'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "expense_splits" ("id" uuid NOT NULL, "expense_id" uuid NOT NULL, "member_id" uuid NOT NULL, "amount" integer NOT NULL, CONSTRAINT "PK_67774a6f95e6b4acf7a5ce861b0" PRIMARY KEY ("id")); COMMENT ON COLUMN "expense_splits"."amount" IS 'Amount in cents'`);
